...
def appearance(intervals: dict[str, list[int]]) -> int:
	...
	for tutor_start, tutor_end in zip(tutor_intervals[::2], tutor_intervals[1::2]):
		for pupil_start, pupil_end in zip(pupil_intervals[::2], pupil_intervals[1::2]):
